...
public class MedianAdapter extends MedianAdaptee implements Classifier {
    ...
    public int publicationYearMedian(Set<com.kodilla.patterns2.adapter.bookclassifier.librarya.Book> bookSet) {
        ...
        for (com.kodilla.patterns2.adapter.bookclassifier.librarya.Book book : bookSet) {
            ...
            com.kodilla.patterns2.adapter.bookclassifier.libraryb.Book adaptedBook = new com.kodilla.patterns2.adapter.bookclassifier.libraryb.Book(
                    book.getAuthor(),
                    book.getTitle(),
                    book.getPublicationYear()
            );
            booksMap.put(bookSignature, adaptedBook);
        }
