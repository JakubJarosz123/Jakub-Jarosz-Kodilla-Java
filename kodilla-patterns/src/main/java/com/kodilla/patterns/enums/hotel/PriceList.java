...
public class PriceList {
    ...
    public static BigDecimal getSingleBedPrice(Season season) {return singleBedPrices.get(season);}
    public static BigDecimal getDoubleBedPrice(Season season) {return doubleBedPrices.get(season);}
}
