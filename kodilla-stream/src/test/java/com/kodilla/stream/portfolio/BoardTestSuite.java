...
public class BoardTestSuite {
    ...
    void testAddTaskListFindUsersTasks() {
        ...
        List<Task> tasks = project.getTaskLists().stream()
                ...
                .filter(u -> u.getAssingedUser().equals(user))
                .collect(toList());

        //Then
        assertEquals(2, tasks.size());
        assertEquals(user, tasks.get(0).getAssingedUser());
        assertEquals(user, tasks.get(1).getAssingedUser());
    }
    ...
    void testAddTaskListAverageWorkingOnTask() {
        ...
        double avg2 = project.getTaskLists().stream()
                ...
                .orElse(0.0);
        //Then
        assertEquals(10.0, avg, 0.01);
        assertEquals(10.0, avg2, 0.01);
    }
}
